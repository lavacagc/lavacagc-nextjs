...
- Outside service area (0pts)
- Email only (10pts)
- Exit intent (5pts) _(historical example; the exit-intent popup now captures a newsletter signup and no longer submits leads - see the deprecation note under Lead Source Quality)_
- No budget (0pts)
- **Tier: 🔵 COLD**
