...
export const metadata: Metadata = {
  title: 'Home & Commercial Services in NJ',
  description:
    'Pick your track: residential repairs and property care, or commercial turnovers, storefronts and CCO prep across Northern New Jersey.',
  openGraph: {
