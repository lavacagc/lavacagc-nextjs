...
const slug = "verona/bathroom-renovation";
...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: `${service} in ${town}, NJ | La Vaca General Contractors`,
    description:
      "Plan a cleaner, better-built Verona bathroom renovation with La Vaca General Contractors.",
    url: canonicalUrl,
    type: "website",
  },
  robots: {
...
const localBusinessJsonLd = {
  ...
  description:
    "Licensed bathroom renovation contractor serving Verona, NJ and nearby Essex County homes.",
  url: canonicalUrl,
...
const reasons = [
  ...
  "Clear communication for busy Verona homeowners, including se habla español for families who prefer Spanish project updates.",
  "Practical Essex County experience with established homes, tight access, tile details, ventilation, waterproofing, and permit coordination.",
];
...
const faqs = [
  {
    question: "How long does a bathroom renovation in Verona usually take?",
    answer:
  ...
  {
    question: "Do Verona bathroom remodels need permits?",
    answer:
  ...
  {
    question: "Can you renovate bathrooms in older Verona homes?",
    answer:
      "Yes. Verona has many established homes with framing, plaster, plumbing, subfloor, and ventilation conditions that need careful sequencing. We plan for those realities instead of treating every bathroom like new construction.",
  },
  {
  ...
  {
    question: "Does La Vaca serve only Verona?",
    answer:
      "No. La Vaca is a service-area contractor serving Verona and nearby communities across Essex, Morris, and Bergen Counties. Verona pages help homeowners find local information, but the team works throughout Northern New Jersey.",
  },
];

export default function VeronaBathroomRenovationPage() {
  return (
    <div className="min-h-screen bg-white text-slate-950">
      ...
      <main>
        <section className="relative overflow-hidden bg-slate-950 text-white">
          {/* TODO: Replace gradient with town-specific photo path for a completed Verona bathroom renovation. */}
          ...
          <div className="relative mx-auto grid max-w-6xl gap-10 px-4 py-20 md:grid-cols-[1.2fr_0.8fr] md:px-6 md:py-28">
            <div>
              ...
              <p className="mt-6 max-w-3xl text-lg leading-8 text-slate-200 md:text-xl">
                Bathroom renovation in Verona should respect the home you already love while fixing the parts that no longer work. La Vaca plans tile, waterproofing, fixtures, storage, ventilation, and finish details with the practical care Verona and Essex County homes deserve.
              </p>
              <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                <Link
                  href="/free-estimate?utm_source=town-page&utm_medium=seo&utm_campaign=verona-bathroom-renovation"
            ...
            <div className="rounded-3xl border border-white/15 bg-white/10 p-6 backdrop-blur">
              <h2 className="text-2xl font-semibold">Built for Verona bathrooms</h2>
        ...
        <section className="mx-auto max-w-6xl px-4 py-16 md:px-6 md:py-20">
          <div className="max-w-3xl">
            <p className="text-sm font-semibold uppercase tracking-wide text-orange-600">Why Verona homeowners choose La Vaca</p>
          ...
          <div className="grid gap-10 md:grid-cols-[0.8fr_1.2fr]">
            <div className="rounded-3xl bg-orange-50 p-8 ring-1 ring-orange-100">
              ...
              <p className="mt-4 leading-7 text-slate-700">
                Verona homes range from colonials, capes, split-levels, townhomes, and older single-family homes near Forest Avenue, Bloomfield Avenue, Verona Park, and the neighborhoods near Montclair and Cedar Grove. Bathrooms in these homes often need more than surface updates: subfloors may need correction, old plumbing may need thoughtful access, and ventilation can be limited by original layouts.
              </p>
            </div>
            <div className="space-y-5 text-lg leading-8 text-slate-700">
              <p>
                A strong Verona bathroom renovation starts by respecting the home’s existing conditions, access, and daily routine. Moving a drain, opening a wall, or switching from a tub to a walk-in shower can be the right choice, but only after the existing conditions are understood. That is why La Vaca focuses on planning, waterproofing, material readiness, and clear sequencing before the room is torn apart.
              </p>
              <p>
                For homeowners preparing a primary suite, updating a hall bath before resale, or making a small bathroom feel brighter and easier to clean, the goal is the same: durable work, clean finishes, and a process that does not turn the rest of the house into a job site. Our team serves Verona and surrounding Essex County communities, and se habla español.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mx-auto max-w-4xl px-4 py-16 md:px-6 md:py-20">
          <h2 className="text-3xl font-bold md:text-4xl">Bathroom renovation FAQs for Verona homeowners</h2>
        ...
        <section className="bg-orange-50 py-16 md:py-20">
          <div className="mx-auto max-w-4xl px-4 text-center md:px-6">
            <h2 className="text-3xl font-bold md:text-4xl">Ready to plan your Verona bathroom renovation?</h2>
            ...
            <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
              ...
              <Link href="/locations/verona" className="rounded-full border border-slate-300 bg-white px-6 py-3 font-semibold text-slate-900 transition hover:bg-slate-50">
                Verona Service Area
              </Link>
