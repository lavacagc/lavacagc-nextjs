...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: 'website',
    url: PAGE_URL,
    images: [{ url: 'https://www.lavacagc.com/og-buy-remodel.png', width: 1200, height: 630, alt: 'Buy + Remodel — curated Northern NJ homes priced to make your own' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Northern NJ Homes to Buy + Remodel | La Vaca GC',
    description: 'Curated homes to buy and renovate in Northern NJ.',
    images: ['https://www.lavacagc.com/og-buy-remodel.png'],
  },
